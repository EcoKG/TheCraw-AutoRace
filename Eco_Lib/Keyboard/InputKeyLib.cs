...
public class InputKeyLib
{
    private static InputKeyLib instance = null;
    public static InputKeyLib GetInstance()
    {
        return instance ?? (instance = new InputKeyLib());
    }
    ...
    public void SendUp(ScanCodeShort a)
    {
        INPUT[] Inputs = new INPUT[1];
        INPUT Input = new INPUT();
        Input.type = 1; // 1 = Keyboard Input
        Input.U.ki.wScan = a;
        Input.U.ki.dwFlags = KEYEVENTF.EXTENDEDKEY | KEYEVENTF.KEYUP;
        Inputs[0] = Input;
        SendInput(1, Inputs, INPUT.Size);
    }
    public void VSendDown(ScanCodeShort a)
    {
        INPUT[] Inputs = new INPUT[1];
        INPUT Input = new INPUT();
        Input.type = 1; // 1 = Keyboard Input
